...
Jetson TX2, a low-power embedded system with \SI{8}{\giga\byte} of shared memory;
Geforce MX130, a laptop GPU with \SI{2}{\giga\byte};
Geforce GTX 1650, a low-end desktop GPU with \SI{4}{\giga\byte}; and Titan RTX, a high-end workstation GPU with \SI{24}{\giga\byte}.
