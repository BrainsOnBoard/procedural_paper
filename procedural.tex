...
Next, we compared the per-layer distributions of rates, spike-train irregularity and cross-correlation coefficients with those obtained from the supercomputer simulations.
