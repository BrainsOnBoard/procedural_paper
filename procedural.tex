...
Furthermore, by distributing the model across \num{160} compute nodes, it can be initialized in approximately \SI{8}{\minute} and simulating \SI{1}{\second} of biological takes only \SI{31}{\second}~\citep{VanAlbada2020}.
