...
This is in contrast to generating large connectivity matrices up front and retrieving them from memory when needed, which is how practically all simulations are run today.
