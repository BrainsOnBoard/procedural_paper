...
\author[1*]{James C Knight}
\author[1]{Thomas Nowotny} 

\affil[1]{Centre for Computational Neuroscience and Robotics, School of Engineering and Informatics, University of Sussex, Brighton, United Kingdom}

\corr{J.C.Knight@sussex.ac.uk}{JCK}

\contrib[\authfn{1}]{is currently the primary GeNN developer and was responsible for extending the code generation approach to the procedural simulation of synaptic connectivity.performed the experiments and the analysis of the results that are presented in this work.wrote paper}
\contrib[\authfn{2}]{is the original developer of GeNN and wrote the paper}
