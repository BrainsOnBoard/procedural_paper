...
However, in order to faithfully reproduce some of the features found in recordings of biological brains, large models are required. 
...
In this work, we present a new method for simulating large models that significantly reduces the amount of required memory.
This method is particularly well-suited for use on Graphical Processing Units~(GPUs), which are a common fixture in many workstations and are used for accelerating simulation software.
