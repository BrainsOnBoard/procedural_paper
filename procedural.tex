...
The models used to produce Fig.~\ref{fig:performance_scaling} and Fig.~\ref{fig:merging_scaling} as well as the pre-processed data used to produce Fig.~\ref{fig:multi_area} are all available at \url{https://github.com/BrainsOnBoard/procedural_paper}.
