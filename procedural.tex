...
This is possible because synaptic connections are typically independent from each other.

For instance, when connecting two populations of neurons with a fixed connection probability $P_{\text{conn}}$, the postsynaptic targets of a presynaptic neuron can be determined by sampling a Bernoulli process with success probability $P_{\text{conn}}$.
