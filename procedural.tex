...
Our implementation of the multi-area model requires a little over \SI{12}{\giga\byte} of GPU memory in total, with the majority~(\SI{8.5}{\giga\byte}) being used for the dendritic delay buffers~(described in our previous work~\citep{Knight2018}).
