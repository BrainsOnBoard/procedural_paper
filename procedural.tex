...
However, even small mammals such as mice have ont the order of \num{1E12} synaptic connections which in simulations are typically charaterized by at least one floating-point value each.
