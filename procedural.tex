...
However, with the procedeural connectivity method we are able to simulate this model on single workstation with one Titan RTX GPU, which has \SI{24}{\giga\byte} of GPU memory.
